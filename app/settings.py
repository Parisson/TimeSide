...
# In DEBUG mode, for session and CSRF cookies
# SameSite is set to Lax and Secure to False
# Without DEBUG, SAMESITE = 'None' is required for player
# and SECURE = True for Chrome in this context
if DEBUG:
...
DCS_SESSION_COOKIE_SAMESITE_FORCE_ALL = not DEBUG
