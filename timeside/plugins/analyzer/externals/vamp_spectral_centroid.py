...
class VampSpectralCentroid(VampAnalyzer):
    ...
    @store_parameters
    def __init__(self):
        super(VampSpectralCentroid, self).__init__()
        # Define Vamp plugin key and output
        self.plugin_key = 'vamp-libxtract:spectral_centroid'
        self.plugin_output = 'spectral_centroid'

    @interfacedoc
    def setup(self, channels=None, samplerate=None,
              blocksize=None, totalframes=None):
        super(VampSpectralCentroid, self).setup(
            channels, samplerate, blocksize, totalframes)

    @staticmethod
    @interfacedoc
    def id():
        return "vamp_spectral_centroid"
    ...
    def post_process(self):
        super(VampSpectralCentroid, self).post_process()  # get remaining results
