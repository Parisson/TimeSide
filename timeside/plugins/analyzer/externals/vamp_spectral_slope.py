...
class VampSpectralSlope(VampAnalyzer):
    ...
    def setup(self, channels=None, samplerate=None,
        ...
        super(VampSpectralSlope, self).setup(
            channels, samplerate, blocksize, totalframes)

    @staticmethod
    @interfacedoc
    def id():
        return "vamp_spectral_slope"
    ...
    def post_process(self):
        super(VampSpectralSlope, self).post_process()  # get remaining results
