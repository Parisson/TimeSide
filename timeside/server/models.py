...
class ShareableResource(models.Model):
    ...
    author = models.ForeignKey(User, related_name="%(class)s", verbose_name=_(
...
class Selection(DocBaseResource, ShareableResource):
    ...
    items = models.ManyToManyField(
        'Item', related_name="selections", verbose_name=_('items'), blank=True)
    selections = models.ManyToManyField(
        'Selection', related_name="other_selections", verbose_name=_('other selections'), blank=True)
...
class Item(DocBaseResource, ShareableResource):
    ...
    hdf5 = models.FileField(
        _('HDF5 result file'), upload_to='results/%Y/%m/%d', blank=True, max_length=1024)
...
class Experience(DocBaseResource, ShareableResource):
    ...
    presets = models.ManyToManyField(
        'Preset', related_name="experiences", verbose_name=_('presets'), blank=True)
    experiences = models.ManyToManyField(
        'Experience', related_name="other_experiences", verbose_name=_('other experiences'), blank=True)
...
class Processor(models.Model):
    ...
    pid = models.CharField(_('pid'), choices=PROCESSOR_PIDS,
...
class SubProcessor(models.Model):
    ...
    """
    sub_processor_id = models.CharField(
        _('sub_processor_id'), unique=True, max_length=128)
    name = models.CharField(_('name'), max_length=256, blank=True)

    processor = models.ForeignKey('Processor', related_name="sub_results", verbose_name=_(
        'processor'), blank=True, null=True)
...
class Preset(BaseResource, ShareableResource):
    ...
    processor = models.ForeignKey('Processor', related_name="presets", verbose_name=_(
        'processor'), blank=True, null=True)
...
class Result(BaseResource, ShareableResource):
    ...
    item = models.ForeignKey('Item', related_name="results", verbose_name=_(
        'item'), blank=True, null=True, on_delete=models.SET_NULL)
    preset = models.ForeignKey('Preset', related_name="results", verbose_name=_(
        'preset'), blank=True, null=True, on_delete=models.SET_NULL)
    hdf5 = models.FileField(
        _('HDF5 result file'), upload_to='results/%Y/%m/%d', blank=True, max_length=1024)
    file = models.FileField(
        _('Output file'), upload_to='results/%Y/%m/%d', blank=True, max_length=1024)
    mime_type = models.CharField(
        _('Output file MIME type'), blank=True, max_length=256)
...
class Task(BaseResource, ShareableResource):
    ...
    experience = models.ForeignKey('Experience', related_name="task", verbose_name=_(
        'experience'), blank=True, null=True)
    selection = models.ForeignKey('Selection', related_name="task", verbose_name=_(
        'selection'), blank=True, null=True)
    status = models.IntegerField(_('status'), choices=STATUS, default=_DRAFT)
...
class Analysis(DocBaseResource, ShareableResource):
    sub_processor = models.ForeignKey(
        SubProcessor, related_name="analysis", verbose_name=_('sub_processor'), blank=False)
    preset = models.ForeignKey(
        Preset, related_name="analysis", verbose_name=_('preset'), blank=False)
...
class AnalysisTrack(DocBaseResource, ShareableResource):
    ...
    analysis = models.ForeignKey(
        Analysis, related_name='tracks', verbose_name=_('analysis'), blank=False)
    item = models.ForeignKey(
        Item, related_name='analysis_tracks', verbose_name=_('item'), blank=False)
...
class Annotation(DocBaseResource):
    track = models.ForeignKey(
        AnnotationTrack, related_name='annotations', verbose_name=_('annotation'), blank=False)
