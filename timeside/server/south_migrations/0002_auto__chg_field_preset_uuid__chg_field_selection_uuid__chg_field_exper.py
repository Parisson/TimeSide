...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Preset.uuid'
        db.alter_column('timeside_presets', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Selection.uuid'
        db.alter_column('timeside_selections', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Experience.uuid'
        db.alter_column('timeside_experiences', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Result.uuid'
        db.alter_column('timeside_results', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Item.uuid'
        db.alter_column('timeside_items', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Task.uuid'
        db.alter_column('timeside_tasks', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Preset.uuid'
        db.alter_column('timeside_presets', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Selection.uuid'
        db.alter_column('timeside_selections', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Experience.uuid'
        db.alter_column('timeside_experiences', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Result.uuid'
        db.alter_column('timeside_results', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Item.uuid'
        db.alter_column('timeside_items', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))

        # Changing field 'Task.uuid'
        db.alter_column('timeside_tasks', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=512, unique=True))
